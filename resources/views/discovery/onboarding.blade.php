    ...
    <div x-show="step === 1"
        ...
        <div x-show="genres.length > 0" class="mt-12 mb-10 w-full relative" x-ref="genreGridContainer">
            ...
            <svg class="absolute inset-0 w-full h-full pointer-events-none z-0" style="overflow: visible;">
                <template x-for="(line, idx) in gridConnections" :key="idx">
                    <line :x1="line.x1" :y1="line.y1" :x2="line.x2" :y2="line.y2" stroke="#a855f7" stroke-width="2" class="opacity-60" stroke-linecap="round"></line>
                </template>
            </svg>
