...
<head>
    ...
    <title>R E C I C L E D ☆ — <?php echo $__env->yieldContent('title', 'Tu Música'); ?></title>
    <link rel="shortcut icon" href="<?php echo e(asset('multimedia/img/logo_3d.ico')); ?>" type="image/x-icon">
    
    <link rel="stylesheet" href="<?php echo e(asset('css/style.css')); ?>">
    <?php echo $__env->yieldPushContent('styles'); ?>
    
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link rel="stylesheet" href="<?php echo e(asset('css/interactividad.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/busqueda.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/estilos-globales.css')); ?>">

    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/app.css', 'resources/js/app.js']); ?>

    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <script src="<?php echo e(asset('js/interacciones-formulario.js')); ?>" defer></script>
    
    <?php echo $__env->yieldPushContent('scripts'); ?>
    <script>
        window.searchRoute = "<?php echo e(route('api.buscar')); ?>";
    </script>
</head>
<body class="bg-gray-100">
    <header>
        ...
        <div class="header-center">
            <div class="img">
                <a href="<?php echo e(url('/')); ?>" style="display:flex; align-items:center; text-decoration:none; gap: 10px;">
                    <img src="<?php echo e(asset('multimedia/img/logo_White.png')); ?>" alt="Project Icon" style="height: 80px; width: 80px; object-fit: contain;">
                </a>
            </div>
        </div>
        <div class="header-right">
            ...
            <div class="usuario-dropdown-contenedor">
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <span class="nombre-usuario-header"><?php echo e(Auth::user()->name); ?></span>
        ...
        <div class="cuadricula-pie">
            <div class="pie p1">
                <div class="imagen-pie">
                    <img src="<?php echo e(asset('multimedia/img/logo_3d.png')); ?>" alt="Footer Logo">
                </div>
    ...
    <script src="<?php echo e(asset('js/busqueda.js')); ?>?v=4"></script>
    <script src="<?php echo e(asset('js/busqueda-artista.js')); ?>?v=4"></script>
...
<?php /**PATH C:\xampp\htdocs\RecicledApp\resources\views/layouts/app.blade.php ENDPATH**/ ?>