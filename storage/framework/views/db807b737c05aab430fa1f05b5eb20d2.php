                ...
                <div class="relative z-10 max-w-7xl mx-auto px-6 pt-12 pb-16">
                    <div class="flex flex-col lg:flex-row items-center gap-12">
                        ...
                        <div class="flex-1 space-y-6">
                            ...
                            <template x-if="dashboardData?.ai_vibe">
                                <div class="mt-4 p-4 bg-purple-50 rounded-xl border border-purple-100 shadow-sm inline-block">
                                    <p class="text-xs uppercase tracking-widest font-bold text-purple-400 mb-1">Tu Perfil de Vibe (IA)</p>
                                    <p class="text-sm font-medium text-purple-900 capitalize" x-text="dashboardData.ai_vibe"></p>
                                </div>
                            </template>
            ...
            try {
                ...
                const res = await fetch('<?php echo e(url("discovery/generate")); ?>', {
                    ...
                    body: JSON.stringify({
                        ...
                        selected_albums_names: this.selectedAlbums.map(a => a.name),
                        selected_tracks_names: this.selectedTracks.map(t => t.name),
                    }),
                });
