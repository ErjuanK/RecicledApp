...
<?php $__env->startPush('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/estilo-panel-artista.css')); ?>">
<?php $__env->stopPush(); ?>
...
<div class="contenedor-panel">
    ...
    <div class="cabecera-artista">
        <div class="contenedor-avatar-relativo" style="position: relative; display: inline-block;">
            <img src="<?php echo e($user->avatar ? asset($user->avatar) : 'https://via.placeholder.com/150'); ?>" alt="Avatar Artista" class="avatar-artista" id="avatar-visual">
        ...
        <div class="info-basica-artista">
            <h1><?php echo e($artista->nombre_artistico); ?></h1>
            <p id="bio-header">
                <?php 
    ...
    <div id="seccion-albumes" class="seccion-pestana activa">
        ...
        <section class="barra-acciones">
            ...
            <div class="grupo-botones">
                <!-- <a href="<?php echo e(route('artist.panel.album.index', $artista->artista_id)); ?>" class="boton-primario">Gestionar Canciones</a> -->
                <a href="<?php echo e(route('artist.panel.album.create', $artista->artista_id)); ?>" class="boton-primario">Subir Nuevo Álbum</a>
            </div>
        </section>

        <!-- Grid de Álbumes -->
        <section class="grid-albumes">
            <?php $__empty_1 = true; $__currentLoopData = $albumes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $album): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <article class="tarjeta-album">
                    <img src="<?php echo e($album->portada_url ? asset($album->portada_url) : asset('multimedia/img/default-album.jpg')); ?>" alt="Portada <?php echo e($album->titulo); ?>" class="imagen-portada">
                    
                    <div class="info-album">
                        <span class="titulo-album"><?php echo e($album->titulo); ?></span>
                        <span class="anio-album"><?php echo e($album->fecha_lanzamiento ? \Carbon\Carbon::parse($album->fecha_lanzamiento)->year : 'N/A'); ?></span>
                        
                        <div class="badge-estado">
                            <?php if($album->estado == 'publico'): ?>
                                <i class="fa-solid fa-earth-americas estado-publico"></i> <span class="estado-publico">Público</span>
                            <?php elseif($album->estado == 'privado'): ?>
                    ...
                    <div class="botones-tarjeta">
                        <a href="<?php echo e(route('artist.panel.album.edit', ['id' => $artista->artista_id, 'albumId' => $album->album_id])); ?>" class="boton-tarjeta"><i class="fa-solid fa-pen"></i> Editar</a>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <article class="tarjeta-album tarjeta-vacia">
                    ...
                    <a href="<?php echo e(route('artist.panel.album.create', $artista->artista_id)); ?>" class="boton-comenzar" style="cursor: pointer;">Comenzar</a>
                </article>
            <?php endif; ?>
            ...
            <?php if(count($albumes) > 0): ?>
             <article class="tarjeta-album tarjeta-vacia">
                ...
                <a href="<?php echo e(route('artist.panel.album.create', $artista->artista_id)); ?>" class="boton-comenzar" style="cursor: pointer;">Crear</a>
            </article>
            <?php endif; ?>
        </section>
    </div>
    ...
    <div id="seccion-canciones" class="seccion-pestana">
        ...
        <section class="grid-canciones">
            <?php $__empty_1 = true; $__currentLoopData = $canciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cancion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <article class="tarjeta-cancion">
                <div class="icono-cancion">
                    <i class="fa-solid fa-music"></i>
                </div>
                <div class="info-cancion">
                    <span class="titulo-cancion"><?php echo e($cancion->titulo); ?></span>
                    <span class="album-cancion"><?php echo e($cancion->nombre_album); ?></span>
                    
                    <div class="meta-cancion">
                        <span><i class="fa-regular fa-clock"></i> <?php echo e(gmdate("i:s", $cancion->duracion)); ?></span>
                        
                        <?php if($cancion->estado == 'publico'): ?>
                        ...
                        <?php elseif($cancion->estado == 'privado'): ?>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
             ...
             <article class="tarjeta-album tarjeta-vacia" style="min-height: 200px; border-color: var(--color-morado-suave);">
                ...
                <div class="texto-vacio">
                    ...
                    <a href="<?php echo e(route('artist.panel.song.create.standalone', $artista->artista_id)); ?>" class="boton-comenzar" style="cursor: pointer;">Comenzar</a>
            </article>
            <?php endif; ?>
            ...
            <?php if(count($canciones) > 0): ?>
             <article class="tarjeta-cancion vacia">
                ...
                <a href="<?php echo e(route('artist.panel.song.create.standalone', $artista->artista_id)); ?>" class="boton-primario">Subir</a>
            </article>
            <?php endif; ?>
        </section>
    </div>
    ...
    <div id="seccion-perfil" class="seccion-pestana">
        ...
        <form id="form-perfil-artista" class="grid-perfil-completo" enctype="multipart/form-data" method="POST" action="<?php echo e(route('artist.panel.update', $artista->artista_id)); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="columna-bio">
                <div class="tarjeta-perfil tarjeta-bio-compacta">
                    ...
                    <textarea name="biografia" class="input-biografia-medium" placeholder="Escribe aquí tu trayectoria, influencias y mensaje..."><?php echo e(old('biografia', $artista->biografia)); ?></textarea>
            ...
            <div class="columna-datos">
                ...
                <div class="tarjeta-perfil">
                    ...
                    <div class="grupo-input">
                        ...
                        <input type="text" name="nombre_artistico" id="input-nombre-artistico" value="<?php echo e(old('nombre_artistico', $artista->nombre_artistico)); ?>" class="input-linea" required>
                    </div>

                    <div class="fila-doble">
                        <div class="grupo-input">
                            <label>Nombre Real</label>
                            <input type="text" name="nombre_real" value="<?php echo e(old('nombre_real', $user->nombre_real)); ?>" placeholder="Tu nombre" class="input-linea">
                        </div>
                        <div class="grupo-input">
                            <label>Apellidos</label>
                            <input type="text" name="apellidos" value="<?php echo e(old('apellidos', $user->apellidos)); ?>" placeholder="Tus apellidos" class="input-linea">
                        </div>
                    </div>
                    ...
                    <div class="grupo-input">
                        ...
                        <input type="email" name="email" value="<?php echo e(old('email', $user->email)); ?>" class="input-linea">
                    </div>
                    ...
                    <div class="fila-doble">
                        <div class="grupo-input">
                            ...
                            <select name="pais" class="input-linea">
                                ...
                                <option <?php echo e((old('pais', $user->pais) == 'España') ? 'selected' : ''); ?>>España</option>
                                <option <?php echo e((old('pais', $user->pais) == 'México') ? 'selected' : ''); ?>>México</option>
                                <option <?php echo e((old('pais', $user->pais) == 'Colombia') ? 'selected' : ''); ?>>Colombia</option>
                                <option <?php echo e((old('pais', $user->pais) == 'Argentina') ? 'selected' : ''); ?>>Argentina</option>
                                <option <?php echo e((old('pais', $user->pais) == 'Estados Unidos') ? 'selected' : ''); ?>>Estados Unidos</option>
                            </select>
                        </div>
                        <div class="grupo-input">
                            <label>Código Postal</label>
                            <input type="text" name="codigo_postal" value="<?php echo e(old('codigo_postal', $user->codigo_postal)); ?>" class="input-linea">
                        </div>
                    </div>
                    <div class="grupo-input">
                        <label>Ciudad</label>
                        <input type="text" name="ciudad" value="<?php echo e(old('ciudad', $user->ciudad)); ?>" class="input-linea">
                    </div>
                </div>
...
<div id="uploadModal" class="modal-overlay" style="display: none;">
    <div class="modal-content">
        ...
        <form id="form-upload-album" action="<?php echo e(route('artist.panel.album.store', $artista->artista_id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div id="step-1" class="wizard-step active">
                ...
                <div class="fila-doble">
                    <div class="grupo-input">
                        ...
                        <input type="date" name="fecha_lanzamiento" class="input-linea" value="<?php echo e(date('Y-m-d')); ?>">
                    </div>
                    <div class="grupo-input">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\RecicledApp\resources\views/artista/panel/index.blade.php ENDPATH**/ ?>